package com.subtrack.notification_service.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, SubscriptionEvent> subscriptionEventConsumerFactory(
            ...
            @Value("${kafka.consumer.group-id:notification-service}") String groupId,
        ...
        JsonDeserializer<SubscriptionEvent> valueDeserializer = new JsonDeserializer<>(SubscriptionEvent.class, false);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, SubscriptionEvent> subscriptionEventKafkaListenerContainerFactory(
            ConsumerFactory<String, SubscriptionEvent> subscriptionEventConsumerFactory
    ) {
